...
class Database:
    def __init__(self, db_name:str, db_user:str, db_pass:str, db_host:str, db_port:int):
        ...
        self.engine = create_engine(DB_URL, pool_size=10, max_overflow=20, pool_recycle=180, pool_pre_ping=True, connect_args={
            "charset": "utf8mb4",
    ...
    def execute_query(self, query, params:dict={}, fetchone:bool|None=None, commit:bool|None=False):
        with self.get_session() as session:
            try:
                ...
                raise AppHttpException(message="Ocurrio un error inesperado en el servidorB", status_code=500, context=context)
    ...
    def call_procedure(self, procedure_name: str, params: list = []):
        try:
            ...
            if e.args[0] == 1644:  # Error customizado desde MariaDB, signal 45000
                raise AppHttpException(f"Ocurrio un error inesperado en el servidor: {e.args[1]}", status_code=500, context=context)
